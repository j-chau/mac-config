# Generated by Powerlevel10k configuration wizard on 2024-11-18 at 10:05 PST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SUFFIX=' %6F❯'
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%A at %H:%M:%S}'
